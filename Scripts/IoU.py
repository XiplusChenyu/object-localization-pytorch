...
def reward_move(old_iou, new_iou):
    return Settings.step_reward if old_iou < new_iou else -1 * Settings.step_reward


def reward_terminal(iou):
    return Settings.terminal_reward if iou > Settings.iou_threshold else -1 * Settings.terminal_reward
